...
void Cmd_TokenizeString(char* text) {
    ...
    while (1) {
        ...
        if (cmd_argc < MAX_ARGS) {
            cmd_argv[cmd_argc] = Z_Malloc((i32) Q_strlen(com_token) + 1);
